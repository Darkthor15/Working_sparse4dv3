...
class RectifyImageNode(Node):
    def __init__(self):
        ...
        self.image_sub = self.create_subscription(
            Image, '/device/camera_front_center_right/image_8bit_color', self.image_callback, 10)
        self.camera_info_sub = self.create_subscription(
            CameraInfo, '/device/camera_front_center_right/camera_info', self.camera_info_callback, 10)
        self.image_pub = self.create_publisher(
            Image, '/CAM_FRONT_RIGHT/image_rect', 10)
        self.camera_info_pub = self.create_publisher(
            CameraInfo, '/CAM_FRONT_RIGHT/camera_info', 10)
