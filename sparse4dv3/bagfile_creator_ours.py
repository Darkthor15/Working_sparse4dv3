...
class MultiCameraPublisher(Node):
    ...
    def publish_data(self):
        ...
        tf_msg_map_base.transform.translation.x = 67.62157288412705 
        tf_msg_map_base.transform.translation.y = 14.691181238604429
        tf_msg_map_base.transform.translation.z = 0.0
        tf_msg_map_base.transform.rotation.x = 0.002171833186660657
        tf_msg_map_base.transform.rotation.y = -0.004008313261251649
        tf_msg_map_base.transform.rotation.z = 0.7129414817918823
        tf_msg_map_base.transform.rotation.w = 0.7012087136550744
    ...
    #   z: 2.186839177921275
        ...
        tf_msg_lidar.transform.translation.x = 0.714  # Adjust as needed.
        tf_msg_lidar.transform.translation.y = 0.0
        tf_msg_lidar.transform.translation.z = -0.137
        ...
        tf_msg_lidar_map.transform.translation.x = 67.62157288412705 
        tf_msg_lidar_map.transform.translation.y = 14.691181238604429
        tf_msg_lidar_map.transform.translation.z = 0.0
        tf_msg_lidar_map.transform.rotation.x = 0.002171833186660657
        tf_msg_lidar_map.transform.rotation.y = -0.004008313261251649
        tf_msg_lidar_map.transform.rotation.z = 0.7129414817918823
        tf_msg_lidar_map.transform.rotation.w = 0.7012087136550744
