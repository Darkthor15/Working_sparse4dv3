...
ros_eval = False     # ROS Node evaluation
...
use_tensorrt = False # Use TensorRT Modules
# Path to TensorRT Modules
trt_paths = {
    "backbone": "ckpt/backbone-trt_int8.pth",
    "neck": "ckpt/neck-trt_int8.pth",
    "encoder": "ckpt/anchor-trt_int8.pth",
    "temp_encoder": "ckpt/temp_anchor-trt_int8.pth"
}
...
model = dict(
    ...
    head=dict(
        ...
        instance_bank=dict(
            ...
            num_anchor=900,
            embed_dims=embed_dims,
            anchor="nuscenes_kmeans900_train.npy",
...
anno_root = "data/nuscenes_annos_pkls/"
...
child_frame_mapping = {
   "CAM_FRONT_LEFT": "CAM_FRONT_LEFT",  # "CAM_FRONT_LEFT": "base_link_fl"     "CAM_FRONT_LEFT": "CAM_FRONT_LEFT",
   "CAM_FRONT_RIGHT": "CAM_FRONT_RIGHT"      # "CAM_FRONT_RIGHT": "base_link_fr"       "CAM_FRONT_RIGHT": "CAM_FRONT_RIGHT"
    # "CAM_FRONT": "CAM_FRONT",
