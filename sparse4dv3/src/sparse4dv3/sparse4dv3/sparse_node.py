...
def process_transforms(infos:list, tfs:list, cfg:Config) -> dict:
    ...
    lidar2ego_translation = [0.714, 0.0, 2.2]
    ...
    # lidar2ego_translation = [0.714, 0.0, -0.137]
    ...
    if cfg.input_modality["use_camera"]:
        ...
        sensor2ego_translation[0] = [1.52387798135, 0.494631336551, 1.50932822144]
        sensor2ego_rotation[0] = [0.6757265034669446, -0.6736266522251881, 0.21214015046209478, -0.21122827103904068, ]
        sensor2ego_translation[1] = [1.5508477543, -0.493404796419, 1.49574800619]
        sensor2ego_rotation[1] = [0.2060347966337182, -0.2026940577919598, 0.6824507824531167, -0.6713610884174485, ]
        # sensor2ego_translation[0] = [0.714, 0.32, -0.137]
        # sensor2ego_rotation[0] = [0.6757265034669446, -0.6736266522251881, 0.21214015046209478, -0.21122827103904068, ]
        # # sensor2ego_rotation[0] = [1.0, 0.0, 0.0, 0.0, ]
        # sensor2ego_translation[1] = [0.714, -0.32, -0.137]
        # # sensor2ego_rotation[1] = [1.0, 0.0, 0.0, 0.0, ]
        # sensor2ego_rotation[1] = [0.2060347966337182, -0.2026940577919598, 0.6824507824531167, -0.6713610884174485, ]
    ...
    def forward(self):
        ...
        and (self.tf_info is not None):
            ...
            for i in range(len(out[0]["img_bbox"]["labels_3d"])):
                ...
                marker = Marker()
                marker.header.frame_id = "base_link_fc"
