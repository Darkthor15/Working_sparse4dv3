...
def process_transforms(infos:list, tfs:list, cfg:Config) -> dict:
    ...
    if cfg.input_modality["use_camera"]:
        ...
        # sensor2ego_rotation[0] = [-0.6736266522251881, 0.21214015046209478, -0.21122827103904068, 0.6757265034669446]
        # sensor2ego_translation[1] = [1.5508477543, -0.493404796419, 1.49574800619]
        # sensor2ego_rotation[1] = [-0.2026940577919598, 0.6824507824531167, -0.6713610884174485, 0.2060347966337182]
        ...
        for i in range(len(cams)):
            ...
            # viewpad = [[[1272.5979470598488,0.0,],[],[]],[[],[],[]]]
